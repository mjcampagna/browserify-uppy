...
},{"namespace-emitter":67}],5:[function(require,module,exports){
'use-strict';
/**
...
},{"@uppy/utils/lib/findDOMElement":37,"preact":69}],8:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"./Plugin":7,"./supportsUploadProgress":9,"@uppy/store-default":30,"@uppy/utils/lib/Translator":33,"@uppy/utils/lib/generateFileID":38,"@uppy/utils/lib/getFileNameAndExtension":43,"@uppy/utils/lib/getFileType":44,"@uppy/utils/lib/getTimeStamp":47,"cuid":59,"mime-match":66,"namespace-emitter":67,"prettier-bytes":70}],9:[function(require,module,exports){
...
},{"./icons":20,"preact":69}],11:[function(require,module,exports){
...
},{"./AddFiles":10,"preact":69}],12:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"./AddFiles":10,"./AddFilesPanel":11,"./FileCard":13,"./FileList":16,"./PickerPanelContent":18,"./PickerPanelTopBar":19,"@uppy/utils/lib/isTouchDevice":51,"classnames":58,"preact":69,"preact-css-transition-group":68}],13:[function(require,module,exports){
function _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
},{"../utils/getFileTypeIcon":23,"../utils/ignoreEvent.js":24,"./FilePreview":17,"preact":69}],14:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"../utils/copyToClipboard":22,"../utils/getFileTypeIcon":23,"../utils/truncateString":25,"./FileItemProgress":15,"./FilePreview":17,"./icons":20,"@uppy/utils/lib/getFileNameAndExtension":43,"classnames":58,"preact":69,"prettier-bytes":70}],15:[function(require,module,exports){
var _require = require('preact'),
...
},{"preact":69}],16:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"./FileItem":14,"classnames":58,"preact":69}],17:[function(require,module,exports){
var getFileTypeIcon = require('../utils/getFileTypeIcon');
...
},{"../utils/getFileTypeIcon":23,"preact":69}],18:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"../utils/ignoreEvent.js":24,"preact":69}],19:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"preact":69}],20:[function(require,module,exports){
var _require = require('preact'),
...
},{"preact":69}],21:[function(require,module,exports){
var _class, _temp;
...
},{"./components/Dashboard":12,"./components/icons":20,"@uppy/core":8,"@uppy/informer":26,"@uppy/status-bar":29,"@uppy/thumbnail-generator":31,"@uppy/utils/lib/Translator":33,"@uppy/utils/lib/findAllDOMElements":36,"@uppy/utils/lib/getDroppedFiles":40,"@uppy/utils/lib/toArray":57,"cuid":59,"resize-observer-polyfill":73}],22:[function(require,module,exports){
/**
...
},{"@uppy/core":8,"preact":69}],27:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"./StatusBarStates":28,"@uppy/utils/lib/prettyETA":54,"classnames":58,"lodash.throttle":65,"preact":69,"prettier-bytes":70}],28:[function(require,module,exports){
module.exports = {
  'STATE_ERROR': 'error',
  'STATE_WAITING': 'waiting',
  'STATE_PREPROCESSING': 'preprocessing',
...
},{"./StatusBar":27,"./StatusBarStates":28,"@uppy/core":8,"@uppy/utils/lib/Translator":33,"@uppy/utils/lib/getBytesRemaining":39,"@uppy/utils/lib/getSpeed":46}],30:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"@uppy/core":8,"@uppy/utils/lib/dataURItoBlob":34,"@uppy/utils/lib/isObjectURL":49,"@uppy/utils/lib/isPreviewSupported":50}],32:[function(require,module,exports){
var _class, _temp;
...
},{"@uppy/companion-client":5,"@uppy/core":8,"@uppy/utils/lib/emitSocketProgress":35,"@uppy/utils/lib/getSocketHost":45,"@uppy/utils/lib/limitPromises":52,"@uppy/utils/lib/settle":56,"tus-js-client":83}],33:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"lodash.throttle":65}],36:[function(require,module,exports){
...
},{"./isDOMElement":48}],37:[function(require,module,exports){
var isDOMElement = require('./isDOMElement');
/**
 * Find a DOM element.
 *
...
},{"./isDOMElement":48}],38:[function(require,module,exports){
/**
...
},{"./utils/fallbackApi":41,"./utils/webkitGetAsEntryApi":42}],41:[function(require,module,exports){
...
},{"../../toArray":57}],42:[function(require,module,exports){
...
},{"../../toArray":57}],43:[function(require,module,exports){
/**
...
},{"./getFileNameAndExtension":43,"./mimeTypes":53}],45:[function(require,module,exports){
...
},{"./secondsToTime":55}],55:[function(require,module,exports){
...
},{"./lib/fingerprint.js":60,"./lib/getRandomValue.js":61,"./lib/pad.js":62}],60:[function(require,module,exports){
...
},{"./pad.js":62}],61:[function(require,module,exports){
...
},{"wildcard":86}],67:[function(require,module,exports){
/**
...
},{"url-parse":85}],78:[function(require,module,exports){
"use strict";
...
},{"./node/isReactNative":75}],83:[function(require,module,exports){
"use strict";
...
},{"./node/storage":79,"./upload":84}],84:[function(require,module,exports){
"use strict";
...
},{"./error":81,"./fingerprint":82,"./node/request":77,"./node/source":78,"./node/storage":79,"extend":63,"js-base64":64}],85:[function(require,module,exports){
(function (global){
'use strict';
...
},{"querystringify":71,"requires-port":72}],86:[function(require,module,exports){
/* jshint node: true */
'use strict';
...
},{"@uppy/core":8,"@uppy/dashboard":21,"@uppy/tus":32}]},{},[87]);
